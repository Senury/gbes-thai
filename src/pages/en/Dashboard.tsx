  ...
  return (
    <DashboardLayout language="en">
      <div className="space-y-6">
        ...
        {/* Subscription Status */}
        <SubscriptionStatus language="en" />
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          <Card>
            ...
            <CardContent>
              <div className="text-2xl font-bold">
                {registration ? getPlanDetails(registration.service, 'en').name : 'None'}
              </div>
              <p className="text-xs text-muted-foreground">
                {registration ? getPlanDetails(registration.service, 'en').price : 'No active plan'}
              </p>
            </CardContent>
          </Card>
        </div>
          ...
          <Card>
            ...
            <CardContent className="space-y-4">
              ...
              <div className="flex items-center gap-2">
                ...
                <Badge className={getPlanDetails(registration.service, 'en').color}>
                  {getPlanDetails(registration.service, 'en').name} - {getPlanDetails(registration.service, 'en').price}
                </Badge>
              </div>
              <div className="flex items-center gap-2">
